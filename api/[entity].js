...
const ENTITIES = {
  clientes:      { table: 'clientes', cols: ['nome', 'documento', 'contato_email', 'contato_telefone'] },
  ...
  visitas:       { table: 'visitas', cols: ['cliente_id', 'propriedade_id', 'unidade_id', 'tecnico_id', 'cultura', 'data_visita', 'responsavel', 'condicao_geral', 'irrigacao', 'nutricao', 'sanidade', 'solo_raiz', 'recomendacoes', 'conclusao', 'situacao', 'status'], filters: ['cliente_id', 'status', 'unidade_id'] },
  ...
  equipamentos:  { table: 'equipamentos', cols: ['propriedade_id', 'cliente_id', 'nome', 'tipo', 'status', 'ultima_manutencao', 'proxima_manutencao'], filters: ['cliente_id', 'status'] },
